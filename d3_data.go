...
func d3LineChartData(writer http.ResponseWriter, request *http.Request) {
	d3DataResult := D3LineDataResult{
		...
		Data: []D3LineData{
			...
			{time.Date(2025, 1, 1, 0, 3, 10, 0, time.UTC), 36.15},
			{time.Date(2025, 1, 1, 0, 3, 20, 0, time.UTC), 36.13},
			{time.Date(2025, 1, 1, 0, 3, 30, 0, time.UTC), 16.09},
			{time.Date(2025, 1, 1, 0, 3, 40, 0, time.UTC), 36.10},
			{time.Date(2025, 1, 1, 0, 3, 50, 0, time.UTC), 36.04},
			{time.Date(2025, 1, 1, 0, 4, 0, 0, time.UTC), 36.11},
